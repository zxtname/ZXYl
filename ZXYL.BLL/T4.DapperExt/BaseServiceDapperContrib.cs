...
namespace ZXYL.BLL
{
    public partial class BaseServiceDapperContrib<T> where T : class, new()
    {
        ...
        /// <returns></returns>
        public List<T> GetListByParms(string where,object parms=null, string sort = null, int limits = -1, string fields = " * ", string orderby = "")
        {
            return dal.GetList(where,parms, sort, limits, fields, orderby);

        }
        public List<T> GetList(string where, string sort = null, int limits = -1, string fields = " * ", string orderby = "")
        {
            return dal.GetList(where, null, sort, limits, fields, orderby);
